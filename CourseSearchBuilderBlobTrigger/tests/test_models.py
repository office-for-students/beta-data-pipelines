...
from models import build_course_search_doc, create_sortable_name, build_locations, build_title, build_length_of_course
...
class TestBuildTitle(unittest.TestCase):
    def test_course_without_title_object(self):
        ...
        input_course = {'kis_course_id': 'test_course_id', 'mode': {'code': '1'}, 'institution': {'pub_ukprn': 'test_institution_id'}}
