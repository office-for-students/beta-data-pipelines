...
from course_search_build.models import build_course_search_doc
from course_search_build.models import build_length_of_course
from course_search_build.models import build_locations
from course_search_build.models import build_subjects
from course_search_build.models import build_title
from course_search_build.models import create_sortable_name
...
class TestBuildLocations(unittest.TestCase):
    ...
    def test_course_with_one_english_location_only(self):
        input_course = {
            "locations": [{"name": {"english": "Bradford Campus"}}]
        }
    ...
    def test_course_with_one_welsh_location_only(self):
        input_course = {
            "locations": [{"name": {"welsh": "Prifysgol Caerdydd"}}]
        }
    ...
    def test_course_with_geo_long_lats_only(self):
        input_course = {
            "locations": [{"latitude": "-1.45638", "longitude": "14.9431"}]
        }
...
class TestBuildTitle(unittest.TestCase):
    ...
    def test_course_with_english_and_welsh_title(self):
        input_course = {
            "title": {"english": "mathematics", "welsh": "mathemateg"}
        }
...
class TestBuildLengthOfCourse(unittest.TestCase):
    def test_course_without_length_of_course(self):
        ...
        self.assertEqual(
            expected_search_length_of_course, search_length_of_course
        )
    ...
    def test_course_with_valid_length_of_course_but_as_string(self):
        input_course = {
            "length_of_course": {"code": "1", "label": "1st stage"}
        }
